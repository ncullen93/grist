...
export const allMembers: Member[] = [
  {
    ...
    state: "GA",
    homeStyle: "Greek Revival",
    homeYear: 1842,
    homeName: "The Holloway House",
  ...
  },
  {
    ...
    state: "SC",
    homeStyle: "Queen Anne",
    homeYear: 1892,
    homeName: "Whitfield Manor",
  ...
  },
  {
    ...
    state: "VA",
    homeStyle: "Italianate",
    homeYear: 1870,
    homeName: "Ashby Place",
  ...
  },
  {
    ...
    location: "Hudson, NY",
    state: "NY",
    homeStyle: "Dutch Colonial",
    homeYear: 1790,
    homeName: "Stone Meadow Farm",
  ...
  },
  {
    ...
    homeStyle: "Victorian",
    homeYear: 1895,
    homeName: "The Chen Painted Lady",
  ...
  },
  {
    ...
    location: "Newport, RI",
    state: "RI",
    homeStyle: "Stick Style",
    homeYear: 1868,
    homeName: "Cliffside Cottage",
...
export const allEvents: DemoEvent[] = [
  {
    ...
    description:
      "Three days of home tours, restoration workshops, and good company in one of America's most beautiful historic districts. This year we're visiting six privately-owned antebellum homes, with hands-on workshops on lime mortar, wood window repair, and navigating the federal tax credit process.",
  ...
  },
  {
    ...
    description:
      "A relaxed video call to connect with other members. Share what you're working on, ask questions, or just listen in.",
    date: "March 14",
    time: "7:00 PM ET",
    type: "Virtual",
    status: "upcoming",
  ...
  },
  {
    ...
    description:
      "Window restoration specialist Thomas Clarke on repairing, weatherstripping, and maintaining original wood windows.",
    date: "March 22",
    time: "12:00 PM ET",
    type: "Virtual",
    status: "upcoming",
  ...
  },
  {
    ...
    description:
      "Margaret Holloway walks us through her 1842 Greek Revival — its history, the challenges, and the restoration journey.",
    date: "April 5",
    time: "6:00 PM ET",
    type: "Virtual",
    status: "upcoming",
  ...
  },
  {
    ...
    description:
      "A step-by-step guide to applying for the 20% Federal Historic Tax Credit. Documentation, timelines, and common pitfalls.",
    date: "April 12",
    time: "11:00 AM ET",
    type: "Virtual",
    status: "upcoming",
  ...
  },
  {
    ...
    description:
      "David Hensley walked us through the ins and outs of insuring a historic property — replacement cost, riders, and what to ask your agent.",
    date: "February 15",
    time: "12:00 PM ET",
    type: "Virtual",
    status: "past",
  ...
  },
  {
    ...
    description:
      "Our monthly gathering. Members shared winter projects and swapped contractor recommendations.",
    date: "February 8",
    time: "7:00 PM ET",
    type: "Virtual",
    status: "past",
  ...
  },
  {
    ...
    description:
      "Susan P. shared the story of her 1790 Dutch Colonial farmhouse in Hudson, NY — from inheritance to National Register listing.",
    date: "January 25",
    time: "6:00 PM ET",
    type: "Virtual",
    status: "past",
  ...
  },
  {
    ...
    description:
      "Members in the Northeast met in Portland, ME for home tours and lunch at a member's restored 1812 Cape Cod.",
    date: "January 11",
    time: "10:00 AM ET",
    type: "In Person",
    status: "past",
...
export function getEventById(id: number): DemoEvent | undefined {
...
export interface MicroPostComment {
  id: number;
  authorSlug: string;
  authorName: string;
  authorPhoto: string;
...
export const allMicroPosts: MicroPost[] = [
  {
    id: 1,
    ...
    authorLocation: "Savannah, GA",
    title: "North wall repointing is finally complete",
    content:
      "The north wall repointing is finally complete. Six months of lime mortar work and every joint looks exactly right. The mason said it was one of the most satisfying projects he\u2019s done in years.",
    image:
    ...
    comments: [
      ...
      {
        id: 102,
        authorSlug: "caroline-a",
        authorName: "Caroline A.",
        authorPhoto:
  ...
  },
  {
    ...
    content:
      "Found original wallpaper samples behind the baseboard in the front parlor today. The pattern is a William Morris \u2018Willow Bough\u2019 \u2014 going to try to source a reproduction.",
    time: "5 hours ago",
    date: "Mar 2, 2026",
    likes: 24,
    comments: [
  ...
  },
  {
    ...
    content:
      "Tax credit check arrived today. Still can\u2019t believe the 20% federal credit actually worked out. If anyone is on the fence about applying, do it.",
    time: "1 day ago",
    date: "Mar 1, 2026",
    likes: 42,
    comments: [
  ...
  },
  {
    ...
    content:
      "Window number 28 of 32 is done. Four more to go. My hands are permanently stained with glazing compound and I wouldn\u2019t have it any other way.",
    image:
      "https://images.unsplash.com/photo-1497219055242-93359eeed651?w=800&h=500&fit=crop&crop=center",
    time: "1 day ago",
    date: "Mar 1, 2026",
    likes: 31,
    comments: [],
  },
  {
    ...
    content:
      "Boxwood garden update: the new plantings from last fall have taken root beautifully. Another year or two and the parterre will look like the 1890s photographs.",
    time: "3 days ago",
    date: "Feb 27, 2026",
    likes: 15,
    comments: [],
...
export function getMicroPostsByAuthorSlug(slug: string): MicroPost[] {
  return allMicroPosts.filter((p) => p.authorSlug === slug);
}

export function getMicroPostById(id: number): MicroPost | undefined {
  return allMicroPosts.find((p) => p.id === id);
}
...
export type ListingCategory = "for-sale" | "wanted" | "free";

export const allListingCategories: { name: string; slug: ListingCategory }[] = [
  { name: "For Sale", slug: "for-sale" },
  { name: "Wanted", slug: "wanted" },
  { name: "Free", slug: "free" },
];

export const allListingTags = [
  "Hardware",
  "Fixtures",
  "Lumber",
  "Doors & Windows",
...
export const allListings: Listing[] = [
  {
    ...
    description:
      "Pulled from a carriage house demolition down the street. Beautiful patina, tight grain, no rot. Boards are 8\u201310 inches wide, 3/4 inch thick. Pickup only in Savannah.",
    price: "$1,200",
    image:
      "https://images.unsplash.com/photo-1601063936640-a0e4e4ed081c?w=800&h=400&fit=crop&crop=center",
    condition: "Good",
    tags: ["Lumber"],
    likes: 14,
    replies: [
  ...
  },
  {
    ...
    description:
      "Need six matching pairs of 3.5-inch brass ball-tip hinges for our second-floor bedroom doors. Happy to buy reproductions if the quality is right, but would love originals if anyone has them.",
  ...
  },
  {
    ...
    description:
      "Removed during our HVAC conversion. All four are in working condition \u2014 just need sandblasting and a coat of paint. Various sizes. Must pick up from Richmond.",
    image:
      "https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=800&h=400&fit=crop&crop=center",
    condition: "Fair",
    tags: ["Fixtures"],
    likes: 22,
    replies: [
  ...
  },
  {
    ...
    description:
      "Two matching brass gas light wall sconces from our 1895 Painted Lady. Already professionally converted to electric with period-appropriate fabric cord. Beautiful etched glass shades included.",
    price: "$850",
    image:
      "https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?w=800&h=400&fit=crop&crop=center",
    condition: "Good",
    tags: ["Fixtures"],
    likes: 31,
    replies: [],
  },
  {
    ...
    description:
      "Our 1790 farmhouse has original hand-forged iron latches and strap hinges on most doors, but three doors are missing their hardware. Looking for period-correct replacements \u2014 original or handmade reproductions.",
    tags: ["Hardware", "Doors & Windows"],
    likes: 11,
    replies: [
      {
  ...
  },
  {
    ...
    description:
      "White Carrara marble mantel with grey veining. Carved corbels and center tablet. Came from a townhouse demolition in Providence. Some minor chips on the hearth slab but the surround is in excellent condition.",
    price: "$2,800",
    condition: "Good",
  ...
  },
  {
    ...
    description:
      "Hand-fired brick from a collapsed outbuilding on our property. Mixed sizes, some with beautiful weathering. Great for garden paths or small projects. You haul.",
    condition: "Salvaged",
  ...
  },
  {
    ...
    description:
      "Removed from our 1856 Greek Revival during restoration. All operable with original pintles. Some need paint stripping but the wood is solid \u2014 cypress lasts forever. Priced per pair.",
    price: "$350/pair",
    image:
  ...
  },
  {
    ...
    description:
      "Need about 30 square feet of 3/4-inch pumpkin pine to patch a couple of damaged areas in our 1812 Cape. Width needs to be 12 inches or wider to match the originals. Will pay well for the right match.",
    tags: ["Lumber"],
    likes: 7,
    replies: [],
  },
